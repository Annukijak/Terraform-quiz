...
# resource with the name of "default"
...
# resource "aws_eip" with the name of "server_static_ip"
...
# resource "aws_security_group" with the name of "web_sec"

resource "aws_security_group" "web_sec" {
  name   = "web security group"
  vpc_id = aws_default_vpc.default.id

# access to only SSH and HTTP
...
# resource "aws_instance with the name of "web_server"
